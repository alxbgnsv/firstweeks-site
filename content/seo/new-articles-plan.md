# FirstWeeks · План новых статей (закрытие недель 14–64)

Существующие 39 статей покрывают недели 1–13. Ниже — 25 новых (a40–a64): итог 64 статьи на 64 недели контента. Приоритет = оценка поискового спроса (High — головные запросы категории). Слаги финальные. Все тексты пишутся без {name} (site-first; приложение показывает «your baby»).

| id | Неделя | Slug | Категория | Приоритет | Батч |
|----|--------|------|-----------|-----------|------|
| a40 | 15 | the-4-month-sleep-regression-survival-guide | Sleep | High | **B1 ✓** |
| a41 | 17 | wake-windows-4-to-12-months | Sleep | High | **B1 ✓** |
| a47 | 23 | starting-solids-the-readiness-checklist | Feeding | High | **B1 ✓** |
| a48 | 25 | first-foods-and-allergens-without-fear | Feeding | High | **B1 ✓** |
| a49 | 27 | gagging-vs-choking-know-the-difference | Feeding | High | **B1 ✓** |
| a59 | 21 | teething-timeline-and-what-actually-helps | Health & Safety | High | **B1 ✓** |
| a42 | 19 | sleep-training-methods-an-honest-map | Sleep | High | **B2 ✓** |
| a53 | 20 | rolling-sitting-crawling-the-motor-map | Development | Med | **B2 ✓** |
| a60 | 31 | baby-fevers-by-age-a-clear-protocol | Health & Safety | High | **B2 ✓** |
| a43 | 30 | the-3-to-2-nap-transition | Sleep | Med | **B2 ✓** |
